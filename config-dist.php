...
$CFG->dbtype    = 'sqlsrv';      // 'pgsql', 'mariadb', 'mysqli', 'sqlsrv' or 'oci'
$CFG->dblibrary = 'native';     // 'native' only at the moment
$CFG->dbhost    = 'DESKTOP-ASS21FB';  // eg 'localhost' or 'db.isp.com' or IP
$CFG->dbname    = 'moodle';     // database name, eg moodle
$CFG->dbuser    = 'Ilhem';   // your database username
$CFG->dbpass    = 'IlhemIlhem23';   // your database password
